    ...
    <section id="pricing" className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16" data-aos="fade-up">
          <span className="text-primary-500 dark:text-primary-400 font-medium">Subscription Plans</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-20">
          ...
          <div className="relative flex flex-col h-full" data-aos="fade-up">
            ...
            <div className="relative bg-white/80 dark:bg-dark-800/50 backdrop-blur-sm rounded-xl border border-dark-200/50 dark:border-white/10 shadow-xl flex-1 flex flex-col">
              ...
              <div className="p-8 pt-12 flex-1">
                <div className="bg-primary-500/10 dark:bg-primary-400/10 rounded-lg w-16 h-16 flex items-center justify-center mb-6">
                  <i className="fas fa-seedling text-primary-500 dark:text-primary-400 text-2xl"></i>
                </div>
                <h3 className="text-xl font-semibold text-dark-900 dark:text-white mb-1">Thought Pro</h3>
                <p className="text-lg font-medium text-primary-500 mb-6">Free</p>
                <ul className="space-y-3 text-dark-600 dark:text-dark-300 mb-8 text-sm">
                ...
                <h4 className="text-lg font-semibold text-dark-900 dark:text-white mb-3">Premium</h4>
                <ul className="space-y-3 text-dark-600 dark:text-dark-300 mb-8 text-sm">
                  <li className="flex items-start">
              ...
              <div className="p-8 pt-0">
                <a href="/thoughtpro" className="block w-full py-3 px-6 text-center rounded-lg border-2 border-primary-500 text-primary-500 dark:text-primary-400 hover:bg-primary-500/10 transition-colors">
                  Get Started
                </a>
              </div>
            </div>
          ...
          <div className="relative flex flex-col h-full" data-aos="fade-up" data-aos-delay="100">
            ...
            <div className="relative bg-white/80 dark:bg-dark-800/50 backdrop-blur-sm rounded-xl border shadow-xl flex-1 flex flex-col">
              ...
              <div className="p-8 pt-12 flex-1">
                <div className="bg-secondary-500/20 rounded-lg w-16 h-16 flex items-center justify-center mb-6">
                  <i className="fas fa-tree text-secondary-500 text-2xl"></i>
                </div>
                <h3 className="text-xl font-semibold text-dark-900 dark:text-white mb-2">Thought Healer</h3>
                <p className="text-lg font-medium mb-6">Free</p>
                <ul className="space-y-3 text-dark-600 dark:text-dark-300 mb-8 text-sm">
                  <li className="flex items-start">
                ...
                <h4 className="text-lg font-semibold mb-3 dark:text-white">Premium</h4>
                <ul className="space-y-3 text-dark-600 dark:text-dark-300 mb-8 text-sm">
                  <li className="flex items-start">
                    <i className="fas fa-check mt-1 mr-3 text-secondary-500"></i>
                ...
                <h4 className="text-lg font-semibold mb-3 dark:text-white">Ultra</h4>
                <ul className="space-y-3 text-dark-600 dark:text-dark-300 text-sm">
                  <li className="flex items-start">
                    <i className="fas fa-check mt-1 mr-3 text-secondary-500"></i>
                    100+ Scans, ₹599/Month
          ...
          <div className="relative flex flex-col h-full" data-aos="fade-up" data-aos-delay="200">
            ...
            <div className="relative bg-white/80 dark:bg-dark-800/50 backdrop-blur-sm rounded-xl border shadow-xl flex-1 flex flex-col">
              ...
              <div className="p-8 pt-12 flex-1">
                <div className="bg-secondary-500/10 rounded-lg w-16 h-16 flex items-center justify-center mb-6">
                  <i className="fas fa-building text-secondary-500 text-2xl"></i>
                </div>
                <h3 className="text-xl font-semibold text-dark-900 dark:text-white mb-2">MiniMinds</h3>
                <p className="text-lg font-medium text-secondary-500 mb-6">Free</p>
                <p className="text-sm text-dark-600 dark:text-dark-300 mb-4">Premium: ₹199/Month, Ultra: ₹299/Month</p>
                <ul className="space-y-2 text-dark-600 dark:text-dark-300 text-sm">
                  <li className="flex items-start">
              ...
              <div className="p-8 pt-0">
                <a href="#signup" className="block w-full py-3 px-6 text-center rounded-lg border-2 border-secondary-500 text-secondary-500 hover:bg-secondary-500/10 transition-colors">
                  Get Started
                </a>
              </div>
            </div>
          ...
          <div className="relative flex flex-col h-full" data-aos="fade-up" data-aos-delay="300">
            ...
            <div className="relative bg-white/80 dark:bg-dark-800/50 backdrop-blur-sm rounded-xl border shadow-xl flex-1 flex flex-col">
              ...
              <div className="p-8 pt-12 flex-1">
                ...
                <h3 className="text-xl font-semibold text-dark-900 dark:text-white mb-2">HerMind</h3>
                <p className="text-lg font-medium text-secondary-500 mb-6">Free</p>
                <p className="text-sm text-dark-600 dark:text-dark-300 mb-4">Premium: ₹99/Month, Ultra: ₹99/Month</p>
                <ul className="space-y-2 text-dark-600 dark:text-dark-300 text-sm">
                  <li className="flex items-start">
                    <i className="fas fa-check mt-1 mr-2 text-secondary-500"></i>
        ...
        <div className="mt-20 max-w-3xl mx-auto" data-aos="fade-up">
          <h3 className="text-2xl font-semibold text-dark-900 dark:text-white mb-8 text-center">
          ...
          <div className="space-y-6">
            {faqs.map((faq, index) => (
              <div
                key={index}
                className="relative bg-white/80 dark:bg-dark-800/50 backdrop-blur-sm rounded-xl p-6 border border-dark-200/50 dark:border-white/10 shadow-md"
              >
                <button
                  onClick={() => toggleFaq(index)}
                  className="flex justify-between items-center w-full text-left"
                >
                  <h4 className="text-lg font-medium text-dark-900 dark:text-white">{faq.question}</h4>
